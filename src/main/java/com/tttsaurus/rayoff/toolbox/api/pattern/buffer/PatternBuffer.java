...
/**
 * A pattern buffer is a list of {@link com.tttsaurus.rayoff.toolbox.api.pattern.Pattern} objects
 * that represent either a block, entity, or item.
 *
...
public interface PatternBuffer {
     ...
     */
    @NonNull
    Pattern get(Pattern.@NonNull Type type, int registryId);
     ...
     */
    boolean contains(Pattern.@NonNull Type type, int registryId);
